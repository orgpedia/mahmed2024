...
1. [mahmed2024-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahmed2024-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
```
git clone https://github.com/orgpedia/mahmed2024.git
```
